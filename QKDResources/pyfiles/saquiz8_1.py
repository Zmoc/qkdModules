...
q1 = prepareQuestion(
    ...
    ' <font size="-1">$\\begin{bmatrix}5\\\\4\\\\10\end{bmatrix}\otimes\\begin{bmatrix}-1\\\\2\end{bmatrix}$&emsp;=&emsp;$\\begin{bmatrix}5\cdot\\begin{bmatrix}-1\\\\2\end{bmatrix}\\\\4\cdot\\begin{bmatrix}-1\\\\2\end{bmatrix}\\\\10\cdot\\begin{bmatrix}-1\\\\2\end{bmatrix}\end{bmatrix}$&emsp;=&emsp;$\\begin{bmatrix}-5\\\\10\\\\-4\\\\8\\\\-10\\\\20\end{bmatrix}$',
)
q2 = prepareQuestion(
