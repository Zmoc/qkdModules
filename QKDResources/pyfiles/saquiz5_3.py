...
q1 = prepareQuestion(
    ...
    "$\\frac{1}{\sqrt{2}}$&emsp;$\\begin{bmatrix}1&1\\\\1&-1\end{bmatrix}$&emsp;$\cdot$&emsp;$\\begin{bmatrix}\\frac{\sqrt{2}}{2}\\\\\\frac{\sqrt{2}}{2}\end{bmatrix}$&emsp;=&emsp;$\\begin{bmatrix}1\\\\0\end{bmatrix}$",
)
q2 = prepareQuestion(
    "b. $\\begin{bmatrix}\\frac{i}{\sqrt{3}}\\\\\\frac{\sqrt{2}}{\sqrt{3}}\end{bmatrix}$",
    ["hint 1"],
    "$\\frac{1}{\sqrt{2}}\\begin{bmatrix}1&1\\\\1&-1\end{bmatrix}$&emsp;$\cdot$&emsp;$\\begin{bmatrix}\\frac{i}{\sqrt{3}}\\\\\\frac{\sqrt{2}}{\sqrt{3}}\end{bmatrix}$&emsp;=&emsp;$\\begin{bmatrix}\\frac{i}{\sqrt{6}}+\\frac{1}{\sqrt{3}}\\\\\\frac{i}{\sqrt{6}}-\\frac{1}{\sqrt{3}}\end{bmatrix}$",
)
q3 = prepareQuestion(
