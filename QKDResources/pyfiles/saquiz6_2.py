...
q1 = prepareQuestion(
    "1. $\\rvert V_1+V_2\\rvert\leq\\rvert V_1\\rvert+\\rvert V_2\\rvert$",
    ["hint 1", "hint 2", "hint 3", "hint 4", "hint 5"],
    " $|V_1+V_2|$&emsp;=&emsp;$\sqrt{\left&#60;V,V\\right&#62;}$&emsp;=&emsp;$\sqrt{190}$&emsp;$\leq$&emsp;  $|V_1|+|V_2|$&emsp;=&emsp;$125+65$&emsp;=&emsp;$190$",
)
q2 = prepareQuestion(
...
def createQuiz6_2():
    ...
    display(
        widgets.HTMLMath(
            value='<font size="+1">Given $V_1=\\begin{bmatrix}3\\\\4\\\\-10i\end{bmatrix} \mbox{ and } V_2=\\begin{bmatrix}8i\\\\0\\\\1\end{bmatrix}$, verify the following numerically:'
        )
    )
