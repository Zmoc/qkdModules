...
slider = widgets.IntSlider(
    value=0, min=0, max=8, step=1, continuous_update=True, disabled=True
)

discuss = widgets.HTML(value='<font size="+1">Alice and Bob compare basis')

widgets.jslink((play, "value"), (slider, "value"))
playbox = widgets.HBox(
    [Label(layout=Layout(width="19%")), play, slider],
...
def createTable():
    ...
    row1 = HBox(
        [
            HBox(
                [
                    VBox(
                        [widgets.HTML(value='<font size="+1">Alice\'s bit')],
                        layout=heading,
                    ),
                    rone[0],
                    rone[1],
    ...
    row2 = HBox(
        [
            VBox(
                [widgets.HTML(value='<font size="+1">Alice\'s basis')], layout=heading
            ),
            rtwo[0],
            rtwo[1],
            rtwo[2],
    ...
    row3 = HBox(
        [
            VBox(
                [widgets.HTML(value='<font size="+1">Alice\'s polarization')],
                layout=heading,
            ),
            rthree[0],
            rthree[1],
    ...
    row4 = HBox(
        [
            VBox([widgets.HTML(value='<font size="+1">Bob\'s basis')], layout=heading),
            rfour[0],
            rfour[1],
            rfour[2],
            rfour[3],
    ...
    row5 = HBox(
        [
            VBox(
                [widgets.HTML(value='<font size="+1">Bob\'s measurement')],
                layout=heading,
            ),
            rfive[0],
            rfive[1],
    ...
    row6 = HBox(
        [
            VBox(
                [widgets.HTML(value='<font size="+1">Public discussion')],
                layout=heading,
            ),
            VBox(
                [widgets.HTML(value='<font size="+1"><b>Alice and Bob Compare Basis')],
                layout=heading2,
            ),
        ],
        layout=border,
    ...
    row7 = HBox(
        [
            VBox([widgets.HTML(value='<font size="+1">Secret key')], layout=heading),
            rseven[0],
            rseven[1],
            rseven[2],
            rseven[3],
...
# Animation
curimg = widgets.Image(value=ux, format="gif", width="70%", height="20%")
...
buttonbox = widgets.HBox(
    [restartbtn, Label(layout=Layout(width="1%")), randombtn],
    layout=Layout(
        display="flex",
        # flex_flow='column',
        align_items="stretch",
