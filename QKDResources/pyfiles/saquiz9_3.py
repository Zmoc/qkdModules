...
q1 = prepareQuestion(
    ...
    "$cos^2 ( \\theta_1-90^{\\circ})$&emsp;$ cos^2(0^{\\circ} - \\theta_1) $&emsp;=&emsp;$ \\frac{1}{4}$\n&emsp;&emsp;&emsp; After solving you find $\\theta = 45^{\\circ}$",
)
q2 = prepareQuestion(
    "1. The brightest.",
    ["hint 1"],
    "It turns out that no value of $\\theta$ will result in $\\frac{1}{3}$. Therefore, it is not achievable",
)
