...
from helpermethods import buttonsuccess, checkComplex, makeButton, newfillblank
...
SAQuiz2_1 = VBox(
    [
        widgets.HTML(value='<b><font size="+2">Q01.03 Self Assessment Quiz'),
        widgets.HTML(
...
def createQuiz2_1():
    ...
    display(
        widgets.HTMLMath(
            value='<font size="+1">Solve the following using cartesian representation. Given that $c_1=3i+4$, $c_2=5+11i$ and $c_3=4i$.'
        )
    )
    qlist2_1.append(
